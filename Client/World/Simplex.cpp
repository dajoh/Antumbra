...
namespace Antumbra
{
	...
	static double F2 = 0.3660254037844386467637; // 0.5*(sqrt(3.0)-1.0)
	static double G2 = 0.2113248654051871177454; // (3.0-sqrt(3.0))/6.0
	...
	static double dot(double g[3], double x, double y)
	{
		return g[0]*x + g[1]*y;
	}

	static double dot(double g[3], double x, double y, double z)
	{
